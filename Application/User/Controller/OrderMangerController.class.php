...
class OrderMangerController extends Controller\UserBaseController
{
    ...
    public function  OrderManger(){
       $model=new Model();
        $sql="select o.*,s.name as shopname,u.username,u.phone as userphone,p.price,t.id as tid  from ers_order as o,ers_shop as s,ers_users as u,ers_price as p,ers_type as t where o.sid=s.id and o.uid=u.id and o.pid=p.id and p.tid=t.id";
